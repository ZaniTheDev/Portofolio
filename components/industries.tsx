        ...
        >
          {INDUSTRIES.map((industry, i) => (
            ...
            >
              ...
              <span
                className="font-[family-name:var(--font-mono)] text-xs font-medium uppercase tracking-[0.14em] opacity-50 transition-colors duration-300 group-hover/cell:opacity-100"
                style={{ color: "#B4622A" }}
              >
                {industry.code}
              </span>
